...
//        }
    ...
    public void searchAvailable() throws DataBaseException, 
        ...
        try {
            searchDto.setMasterCode(getMasterEntityKey() == null ? 
                                    ...
                                    getMasterEntityKey());
            searchDto.setRegulationStatus(1l);                      
    ...
    public void setSelectedRegParent() throws DataBaseException, 
        ...
        for (IBasicDTO dto: getAvailableDetails()) {
            ...
            if (checked != null && checked) {
                ...
                BeansUtil.setValue("regulationCycleMaintainBean.pageDTO.parentRegulationDTO", 
                                   dto);
                break;
            }
        }
    ...
    public void resetRegParent(){
        BeansUtil.setValue("regulationCycleMaintainBean.pageDTO.parentRegulationDTO",null);
    }
...
//                           null);
    ...
    public List<IBasicDTO> getStatus() throws DataBaseException, 
        ...
        if (status == null || status.size() == 0) {
            ...
            if (status != null) {
                boolean addMode = 
                    ((Boolean)BeansUtil.getValue("regulationCycleMaintainBean.maintainMode==0"));
                Object currentRegStatusObj = 
                    BeansUtil.getValue("regulationCycleMaintainBean.pageDTO.statusDTOKey");
                if (addMode || 
    ...
    public boolean isCanceledRegulation() {
        if ((Boolean)BeansUtil.getValue("regulationCycleMaintainBean.maintainMode==1")) { //Edit
            IRegulationsDTO pageDTO = 
                (IRegulationsDTO)BeansUtil.getValue("regulationCycleMaintainBean.pageDTO");
    ...
    public void setFakeImageString(String fakeImageString) {
        ...
        if (fakeImageString != null && fakeImageString.length() > 1) {
            Map<String, Object> detailsSavedStates = 
                (Map<String, Object>)BeansUtil.getValue("regulationCycleMaintainBean.detailsSavedStates");
    ...
    public String getFakeImageString() {
        ...
        if (!(isInvalidImageType() || isUploadingError())) {
            Map<String, Object> detailsSavedStates = (Map<String, Object>)BeansUtil.getValue("regulationCycleMaintainBean.detailsSavedStates");
            if(detailsSavedStates != null)
        ...
        if(fakeImageString == null || (isInvalidImageType() || isUploadingError())){
            ...
            String imageName = (String)BeansUtil.getValue("regulationCycleMaintainBean.pageDTO.regulationImage");
    ...
    public boolean isDisableStatusMenu() {
        ...
        boolean editMode = 
            ((Boolean)BeansUtil.getValue("regulationCycleMaintainBean.maintainMode==1"));
        Object currentRegStatusObj = 
            BeansUtil.getValue("regulationCycleMaintainBean.pageDTO.statusDTOKey");
...
//        if ((Boolean)BeansUtil.getValue("regulationCycleMaintainBean.maintainMode==1")){
//            return;
//        }
...
if(maintainBean.getCurrentStage()==1)
    ...
    if(maintainBean.getCurrentStage()==2)
            return "regulationcyclerevisionmaindata";
       else if(maintainBean.getCurrentStage()==3)
            return "regulationcycleexcutemaindata";
            else return null;
