...
public class DecisionCycleMaterialsMaintain extends ManyToManyDetailsMaintain {
    ...
    public DecisionCycleMaterialsMaintain() {
...
//        setPageDTO((IRegDecisionMaterialsDTO)getCurrentDisplayDetails().get(index));
        ...
        return "relatedDecisionCycleMaterials";
    }
