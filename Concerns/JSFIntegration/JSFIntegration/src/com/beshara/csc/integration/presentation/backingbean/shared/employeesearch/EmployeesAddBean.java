package com.beshara.csc.integration.presentation.backingbean.shared.employeesearch;
...
public class EmployeesAddBean extends ManyToManyDetailsMaintain {
  ...
  // added by Nora to enable scrolling
    ...
    private final static String completeSearchPath="/module/jsps/shared/employeesearch/employeeadd.jsp";
    private final static String resultSearchPath="/module/jsps/shared/employeesearch/searchresult.jsp";
    
    public EmployeesAddBean() {
    ...
    public void openWorkCenter(){
     ...
     if(!showCategoryCB && !showMinistryCB && (workMinistries==null))
       ...
       getLovBaseBean().setReturnMethodName("employeesAddBean.addWorkCenter");
       getLovBaseBean().setSearchMethod("employeesAddBean.searchWorkCenter");
       ...
       getLovBaseBean().setCancelSearchMethod("employeesAddBean.cancelWorkSearch");
    }
      /**
    ...
    public void openJob(){
        ...
        getLovBaseBean().setReturnMethodName("employeesAddBean.addJob");
        getLovBaseBean().setSearchMethod("employeesAddBean.searchJob");
        getLovBaseBean().setSelectedDTOS(new ArrayList());
        getLovBaseBean().setSelectedRadio("");
        getLovBaseBean().setSearchTyp("0");
        getLovBaseBean().setSearchQuery("");
        getLovBaseBean().setSearchMode(false);
        getLovBaseBean().setCancelSearchMethod("employeesAddBean.cancelJobSearch");
    }
      /**
    ...
    if(getLovBaseBean().getSelectedDTOS()!=null && getLovBaseBean().getSelectedDTOS().get(0)!=null && getLovBaseBean().getSelectedDTOS().get(0).getCode()!=null){
    ...
    public void searchJob(Object searchType,Object searchQuery){
        ...
        if(searchQuery!=null && !searchQuery.toString().equals("") && searchType!=null && !searchType.equals("")){
 ...
 public String cancelWorkSearch(){
    ...
    public void fillMinistries() {
        ...
        if(ministries==null)ministries=new ArrayList();
    ...
    public void fillWorkMinistries() {
        ...
        if(workMinistries==null)workMinistries=new ArrayList();
   ...
   */  
    ...
    public List<IJobsDTO> getTechnicalJobs() {
        ...
        if(technicalJobs==null)technicalJobs=new ArrayList();
    ...
    public List<IBasicDTO> getHireCurrentStatuses() {
        ...
        if(hireCurrentStatuses ==null )hireCurrentStatuses = new ArrayList();
    ...
    public List<IBasicDTO> getHireStatuses() {
        ...
        if( hireStatuses ==null) hireStatuses = new ArrayList();
        return hireStatuses;
    }
    ...
    public List<IBasicDTO> getResdientTypes() {
        ...
        if(resdientTypes==null)resdientTypes=new ArrayList();
    ...
    public List<IBasicDTO> getSpecialCaseTyps() {
        ...
        if(specialCaseTyps==null)specialCaseTyps=new ArrayList();
    ...
    public List<IBasicDTO> getNationalties() {
        if (nationalties.size() == 0) {
            try {
                nationalties = 
                        InfClientFactory.getCountriesClient().getCodeName();
            } catch (DataBaseException e) {
        ...
        if(nationalties==null)nationalties=new ArrayList();
        return nationalties;
    }
    ...
    public List<IBasicDTO> getCapTyps() {
        if (capTyps.size() == 0) {
            try {
                capTyps = 
                        InfClientFactory.getHandicapStatusClient().getCodeName();
            } catch (DataBaseException e) {
        ...
        if(capTyps==null)capTyps=new ArrayList();
        return capTyps;
    }
    ...
    public List<IBasicDTO> getGovernments() {
       ...
       if(governments ==null) governments = new ArrayList<IBasicDTO>();
        return governments;
    }
    ...
    public List<IBasicDTO> getGenderTyps() {
        if (genderTyps.size() == 0) {
            try {
                genderTyps = 
                        InfClientFactory.getGenderTypesClient().getCodeName();
            } catch (DataBaseException e) {
        ...
        if(genderTyps ==null)genderTyps = new ArrayList<IBasicDTO>();
        return genderTyps;
    }
    ...
    public List<IBasicDTO> getMaritalStatusTyps() {
        ...
        if(maritalStatusTyps ==null)maritalStatusTyps = new ArrayList<IBasicDTO>();
    ...
    public List<IBasicDTO> getRelgionTyps() {
        if (relgionTyps.size() == 0) {
            try {
                relgionTyps = 
                        InfClientFactory.getReligionsClient().getCodeName();
            } catch (DataBaseException e) {
        ...
        if(relgionTyps ==null)relgionTyps = new ArrayList();
        return relgionTyps;
    }
    ...
    public List<IBasicDTO> getHireTypes() {
        ...
        if(hireTypes ==null)hireTypes = new ArrayList();
        return hireTypes;
    }
    ...
    public void searchAvailable() throws DataBaseException, 
        ...
        setAvailableDetails(new ArrayList<IBasicDTO>(0));
         if((searchMethod==null) || searchMethod.equals("")){
            ...
            if(selectedCaderCode != null && !selectedCaderCode.equals(getVirtualConstValue()) &&  !"".equals(selectedCaderCode))
                   getEmployeeSearchDTO().setCaderCode(Long.parseLong(selectedCaderCode));
                   
            
            if(selectedGroupCode != null && !selectedGroupCode.equals(getVirtualConstValue()) && !"".equals(selectedGroupCode))
                       getEmployeeSearchDTO().setGroupCode(Long.parseLong(selectedGroupCode));
              
                    
            if(getEmployeeSearchDTO().getElmguideCode() != null && !getEmployeeSearchDTO().getElmguideCode().equals(getVirtualLongValue()))
                       getEmployeeSearchDTO().setDegreeCode(getEmployeeSearchDTO().getElmguideCode());
                   
            
              setAvailableDetails(EmpClientFactory.getEmployeesClient().search(employeeSearchDTO));
                   } 
                catch (SharedApplicationException e) {
                        setAvailableDetails(new ArrayList());
                        e.printStackTrace();}
                ...
                List searchList=new ArrayList();
                    ...
                    params[0] = employeeSearchDTO;
                  searchList = (List)executeMethodBindingWithParams(searchMethod,params,new Class[]{Object.class});
             if(searchList!=null)
                setAvailableDetails(searchList);
         }
        ...
        if(!showResultWithinPage)
           getSharedUtil().handleNavigation("Result_Emp_Search_Page");
 ...
 * 
  ...
  */
    ...
    employeeSearchDTO.setKuwaiti(true);
         ...
         System.out.println("setMinistryID======="+getMinistryID());
