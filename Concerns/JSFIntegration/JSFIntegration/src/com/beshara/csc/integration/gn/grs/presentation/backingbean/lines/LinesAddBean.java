...
public class LinesAddBean extends LookupMaintainBaseBean {
    ...
    private List<IBasicDTO> selectedAvailableValues = 
    ...
    public String updateParameterDTO() {
        ...
        if ((parameterCode != null) && !parameterCode.equals("")) {
            ...
            try {
                ...
                //validSQL=parametersDTO.isValidSQL();
                availableValues = 
    ...
    public String saveLine() throws DataBaseException, Exception {
        ...
        if (getPageDTO() != null) {
            ...
            if ((parameterCode != null) && !parameterCode.equals("")) {
                ...
                //((LinesDTO)getPageDTO()).setParameterCode(Long.parseLong(parameterCode));
                ((ILinesDTO)getPageDTO()).setParametersDTO(parametersDTO);


            }
            if ((operationCode != null) && !operationCode.equals("")) {
                IEntityKey operatorEntityKey = 
                    GrsEntityKeyFactory.createParametersEntityKey();
                operatorEntityKey = 
            ...
            ILineValuesDTO lineVal = GrsDTOFactory.createLineValuesDTO();
            ...
            if (!validSQL) {
                ...
                try {
                    ...
                    if (mulitValue.intValue() == 0 || 
                        ...
                        lineVal = GrsDTOFactory.createLineValuesDTO();
                        lineVal.setLnevalue(lineValuesArray[0]);
                        lineValueList.add(lineVal);
    ...
    public void radioChanged(ActionEvent ae) {
        IClientDTO selected = 
            (IClientDTO)this.getAvailableDataTable().getRowData();
        selectedAvailableValues = new ArrayList();
            ...
            try {
                ...
                if (operatorsDTO.getMultiValues().intValue() == 
                    ...
                    if (operatorsDTO.getMultiValues().intValue() == 
                        ...
                        mulitValue = 2L;
                    if (operatorsDTO.getMultiValues().intValue() == 
                        ISystemConstant.OPERATOR_MULTI_VALUED)
                        mulitValue = 3L;
                }
            } catch (SharedApplicationException e) {
                // TODO
    ...
    public void selectedAvailable(ActionEvent event) throws Exception {
        System.out.println(" here action listener        ------------------selectedAvailable");
        try {
            selectedAvailableValues = new ArrayList();
    ...
    public int getAvailableListSize() {
        if (availableValues != null)
            availableListSize = availableValues.size();
    ...
    public String changeLineOverView(ActionEvent ae) {
        ...
        if ((operationCode != null) && !operationCode.equals("")) {
            try {
                ...
                operatorDTO = 
                        (IOperatorsDTO)operatersClient.getById(entityKey);
