...
<t:panelGrid columns="1" width="100%">
 <t:panelGroup forceId="true" id="divDeleteConfirm" styleClass="delDivScroll">
  <t:dataTable id="dataT_DeleteConf" var="list" value="#{pageBeanName.deleteStatusDTOS}" preserveDataModel="false" renderedIfEmpty="false" footerClass="grid-footer" sortable="false"
   ...
   <t:column sortable="false" width="40%" defaultSorted="true">
    <f:facet name="header">
     <h:outputText id="name" value="#{globalResources.Code}"/>
    </f:facet>
    <h:outputText id="popup_name" value="#{list.currentObject.code.key}"/>
   </t:column>
 ...
 <t:panelGrid align="center">
  ...
  <t:commandButton forceId="true" id="CancelButtonDelConfirmDiv" onblur="settingFoucsAtDivDeleteConfirm();" styleClass="cssButtonSmall" value="#{globalResources.back}" onclick="hideLookUpDiv(window.blocker,window.delConfirm,null,null); return false;"/>
 </t:panelGrid>
</t:panelGrid>
