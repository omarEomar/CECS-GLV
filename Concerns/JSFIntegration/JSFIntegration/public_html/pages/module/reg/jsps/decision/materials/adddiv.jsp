...
<t:panelGroup forceId="true" id="divAddLookup">
    ...
    <t:panelGroup rendered="#{detailBeanName.addDivShown}">
        ...
        <t:panelGrid columns="2" border="0" rowClasses="row01,row02"  width="100%" cellpadding="3" cellspacing="0" >
                ...
                <t:panelGroup>
                    <t:inputText onblur="document.getElementById('regmaterialText').focus();" onchange="trimBorders(add_first_inputTxt);"  forceId="true" maxlength="#{pageBeanName.nameMaxLength}" id="add_first_inputTxt" styleClass="textboxlarge" value="#{detailBeanName.pageDTO.decmaterialHeader}"/>
                    <t:outputText value="*" styleClass="mandatoryAsterisk"/>
                    <htm:br/> 
                    <c2:requiredFieldValidator componentToValidate="add_first_inputTxt" highlight="false" display="dynamic" errorMessage="#{globalResources.missingField}" active="#{decisionMaterialsMaintainBean.addDivShown}"/>
                </t:panelGroup>
                ...
                <t:panelGroup>
                    <t:inputTextarea  value="#{detailBeanName.pageDTO.decmaterialText}" forceId="true"  id="regmaterialText" rows="4" cols="32"/>
                    <t:outputText value="*" styleClass="mandatoryAsterisk"/>
                    <htm:br/> 
                    <c2:requiredFieldValidator componentToValidate="regmaterialText" highlight="false" display="dynamic" errorMessage="#{globalResources.missingField}" active="#{decisionMaterialsMaintainBean.addDivShown}"/>
                </t:panelGroup>
        </t:panelGrid>
