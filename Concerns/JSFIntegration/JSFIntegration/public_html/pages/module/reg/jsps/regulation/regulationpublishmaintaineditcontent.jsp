...
<%@ taglib uri="http://beshara.net/projects/jsf-comp/clientvalidators"  prefix="c2"%>
        ...
        <!-- -->
            ...
            <t:dataTable id="dataT_data" var="list" renderedIfEmpty="false"
                   ...
                   <t:column id="check_column_" width="5%">
                        <f:facet name="header">
                   ...
                   <t:column id="code_column" width="45%">
                        <f:facet name="header">
                   ...
                   <t:column id="publish_date_column" width="10%">
                        <f:facet name="header">
                            <h:outputText id="header_publish_date" value="#{regResources.regulation_publish_publish_date}"/>
                             <%--t:commandSortHeader id="publish_date_column_sort" columnName="code" arrow="false" styleClass="standardTable_Header2" immediate="true">
                                  <f:facet name="ascending">
                                        <t:graphicImage id="ascendingArrow" value="/app/media/images/ascending-arrow.gif" rendered="true" border="0"/>
                                  </f:facet>
                                  <f:facet name="descending">
                         ...
                         <t:panelGrid cellpadding="0" cellspacing="0" border="0" >
                               <t:panelGroup>                         
                                    ...
                                    <c2:requiredFieldValidator componentToValidate="clndr_maintain_ministriesPublishDate_DataTableCalender"
                                                                        display="dynamic"
                                    ...
                                    <c2:compareDateValidator componentToValidate="mainRegDateID"
                                                                        componentToCompare="clndr_maintain_ministriesPublishDate_DataTableCalender"
                                                                        display="dynamic"
                   ...
                   <t:column id="until_date_column" width="10%">
                        <f:facet name="header">
                            <h:outputText id="header_until_date" value="#{regResources.regulation_publish_until_date}"/>
                             <%--t:commandSortHeader id="until_date_column_sort" columnName="code" arrow="false" styleClass="standardTable_Header2" immediate="true">
                                  <f:facet name="ascending">
                                        <t:graphicImage id="ascendingArrow" value="/app/media/images/ascending-arrow.gif" rendered="true" border="0"/>
                                  </f:facet>
                                  <f:facet name="descending">
                  ...
                  <t:column id="number_column" width="15%">
                        <f:facet name="header">
                            <h:outputText id="header_newsNumber" value="#{regResources.regulation_publish_number}"/>
                        </f:facet>
                        <h:inputText id="newsNumber_name" value="#{list.publishRefrence}" styleClass="textboxsmall2" maxlength="10"/>
                   </t:column>
                   
                   <t:column id="newsNotes_column" width="15%">
                        <f:facet name="header">
                            <h:outputText id="header_newsNotes" value="#{regResources.regulation_publish_notes}"/>
                        </f:facet>
                        <h:inputText id="newsNotes_name" value="#{list.publishNotes}" styleClass="textbox" maxlength="#{pageBeanName.nameMaxLength}"/>
                   </t:column>
        ...
        <t:inputHidden forceId="true" id="calederIDandLeftTopDeductionsHiddenFieldID" value="dataTableCalenderPosition,200,10"/>