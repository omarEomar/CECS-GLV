...
<%@ taglib uri="https://ajax4jsf.dev.java.net/ajax" prefix="a4j"%>
              ...
              <t:panelGroup forceId="true" id="divDeleteAlert" styleClass="delDivScroll">
                   ...
                   <%--t:column id="code_column"  width="20%">
                     ...
                     <h:outputText id="content_code" value="#{list.code.keys[4] > 0 ? list.code.keys[4] : regResources.unDefineLabel}"/>
                   </t:column--%>
                   
                   <t:column id="name_column"  width="75%">
                       <f:facet name="header">
                          
                              <h:outputText id="header_name" value="#{regResources.columnName}"/>
