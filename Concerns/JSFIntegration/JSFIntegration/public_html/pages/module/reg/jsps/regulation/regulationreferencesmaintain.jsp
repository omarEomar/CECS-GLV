...
<f:view locale="#{shared_util.locale}">
 ...
 <h:form id="myForm" binding="#{regulationReferencesMaintainBean.frm}">

    <t:aliasBean alias="#{pageBeanName}" value="#{regulationMaintainBean}">
    <t:aliasBean alias="#{detailBeanName}" value="#{regulationReferencesMaintainBean}">
    ...
    <tiles:insert definition="regulationreferencesmaintain.page" flush="false">
