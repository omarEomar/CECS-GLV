 ...
 <t:panelGroup forceId="true" id="dataT_data_panel">
    ...
    <t:dataTable id="dataT_data" var="list" value="#{detailBeanName.currentDisplayDetails}"
        ...
        <t:column id="code_column"  width="5%">
          ...
          <t:outputText id="content_code"value="#{list.code.keys[0] > 0 ? list.code.keys[0] : regResources.unDefineLabel}"/>
        </t:column>
        ...
        <t:column id="name_column_area"  width="60%">
          ...
          <t:outputText id="content_nameArea" value="#{list.regmaterialText}"/>
        </t:column>
         <t:column id="reg_related_material" sortable="false" width="10%" styleClass="standardTable_ColumnCentered" >
            <f:facet name="header">
            </f:facet>
            <t:graphicImage id="relatedMaterial" value="/app/media/images/icon_details_number.gif" rendered="true" onmouseover="doTooltip(event,'#{regResources.has_related_material}(#{list.relatedMaterialsCount})')" onmouseout="hideTip()" border="0"/>
          </t:column>
