...
<t:panelGroup forceId="true" id="divEditLookup" >
    ...
    <h:panelGrid columns="1" rendered="#{pageBeanName.showEdit}" width="100%">
        ...
        <t:panelGrid columns="3" border="0" align="center">
            ...
            <%--a4j:commandButton id="CancelButtonEdit" styleClass="cssButtonSmall" value="#{globalResources.back}"  action="#{pageBeanName.cancelEdit}" oncomplete="hideLookUpDiv(window.blocker,window.lookupEditDiv,'myForm:NameEdit','myForm:errorEdit');" reRender="scriptPanelGroup"
                    onblur=" setFocusOnlyOnElement('NameEdit');"/--%>
            <t:panelGroup>
                    <t:commandButton forceId="true" id="CancelButtonEdit" styleClass="cssButtonSmall" value="#{globalResources.back}" onblur=" setFocusOnlyOnElement('NameEdit');" onclick="cancelButtonFunction();"/>
                    <a4j:jsFunction name="cancelButtonFunction"  action="#{pageBeanName.cancelEdit}" oncomplete="hideLookUpDiv(window.blocker,window.lookupEditDiv,'myForm:NameEdit','myForm:errorEdit');" reRender="scriptPanelGroup"/>
            </t:panelGroup>
        </t:panelGrid>
    </h:panelGrid>
</t:panelGroup>
