...
<t:panelGrid columns="1" width="100%">
    ...
    <t:panelGrid columns="2" align="center">
        ...
        <t:commandButton forceId="true" id="OkButtonDelAlertDiv" styleClass="cssButtonSmall" value="#{globalResources.ok}" action="#{pageBeanName.deleteDiv}" onblur="setFocusOnlyOnElement('CancelButtonDelAlertDiv');"/>
        <t:commandButton forceId="true" id="CancelButtonDelAlertDiv" styleClass="cssButtonSmall" value="#{globalResources.cancel}" onclick="hideLookUpDiv(window.blocker,window.delAlert,null,null); return false;" onblur="setFocusOnlyOnElement('OkButtonDelAlertDiv');"/>
