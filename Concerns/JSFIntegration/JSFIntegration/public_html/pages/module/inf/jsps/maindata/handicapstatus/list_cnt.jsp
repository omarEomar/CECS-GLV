    ...
    <t:panelGroup forceId="true" id="dataT_data_panel">
        ...
        <t:dataTable id="dataT_data" var="list" value="#{pageBeanName.usingPaging ? pageBeanName.pagingBean.myPagedDataModel : pageBeanName.myTableData}" rowStyleClass="#{ pageBeanName.selected ? 'standardTable_RowHighlighted' : null}"
            ...
            <t:column id="name_column" sortable="false" width="65%">
             ...
             <t:column id="handicapRatio_column" sortable="false" width="10%">
                <f:facet name="header">

                    <t:commandLink id="sort_handicapRatio" forceId="true" styleClass="headerLink" value="#{resourcesBundle.INF_HandicapStatusDTO_handicapRatio}%" actionListener="#{pageBeanName.sortDataTable}">                         
                        <t:graphicImage  value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='handicapRatio') ? '/app/media/images/ascending-arrow.gif' : ''}"  border="0"/>
                        <t:graphicImage  value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='handicapRatio') ? '/app/media/images/descending-arrow.gif' :''}"  border="0"/>
                    </t:commandLink>
