        ...
        <t:dataTable id="dataT_data" var="list" value="#{pageBeanName.usingPaging ? pageBeanName.pagingBean.myPagedDataModel : pageBeanName.myTableData}" rowStyleClass="#{ pageBeanName.selected ? 'standardTable_RowHighlighted' : null}"
            ...
            <t:column id="code_column" sortable="false"  width="10%">
                <f:facet name="header">
                    ...
                    <t:commandLink id="sort_code-cntryCode" forceId="true" styleClass="headerLink" value="#{resourcesBundle.INF_CountriesDTO_code_key}" actionListener="#{pageBeanName.sortDataTable}">                         
            ...
            <t:column id="name_column" sortable="false" width="15%">
                <f:facet name="header">
                    ...
                    <t:commandLink id="sort_name" forceId="true" styleClass="headerLink" value="#{resourcesBundle.INF_CountriesDTO_name}" actionListener="#{pageBeanName.sortDataTable}">                         
             ...
             <t:column id="capital_column" sortable="false" width="10%">
                <f:facet name="header">
                    <t:commandLink id="sort_x" forceId="true" styleClass="headerLink" value="#{resourcesBundle.INF_CountriesDTO_countryCitiesDTOList}" actionListener="#{pageBeanName.sortDataTable}">       
                                <f:param name="listExpression" value="countriesListBean.myTableData"/>
                                <f:param name="currentSortingRowIndex" value="countriesListBean.currentSortingRowIndex"/>
                                <f:param name="elExpression" value="( !empty countriesListBean.myTableData[countriesListBean.currentSortingRowIndex].countryCitiesDTOList ? countriesListBean.myTableData[countriesListBean.currentSortingRowIndex].countryCitiesDTOList[0].name :null)"/>
                        <t:graphicImage  value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='x') ? '/app/media/images/ascending-arrow.gif' : ''}"  border="0"/>
                        <t:graphicImage  value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='x') ? '/app/media/images/descending-arrow.gif' :''}"  border="0"/>
                    </t:commandLink>
                   
                </f:facet>
                <h:outputText id="content_capital" value="#{list.countryCitiesDTOList[0].name}"/>
            </t:column>
           
            <t:column id="language_column" sortable="false" width="15%">
                <f:facet name="header">

                    <t:commandLink id="sort_languagesDTO-name" forceId="true" styleClass="headerLink" value="#{resourcesBundle.INF_CountriesDTO_languagesDTO_name}" actionListener="#{pageBeanName.sortDataTable}">                         
                        <t:graphicImage  value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='languagesDTO-name') ? '/app/media/images/ascending-arrow.gif' : ''}"  border="0"/>
                        <t:graphicImage  value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='languagesDTO-name') ? '/app/media/images/descending-arrow.gif' :''}"  border="0"/>
                    </t:commandLink>
              ...
              <t:column id="currency_column" sortable="false" width="15%">
                <f:facet name="header">
                    ...
                    <t:commandLink id="sort_currenciesDTO-name" forceId="true" styleClass="headerLink" value="#{resourcesBundle.INF_CountriesDTO_currenciesDTO_name}" actionListener="#{pageBeanName.sortDataTable}">                         
                        <t:graphicImage  value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='currenciesDTO-name') ? '/app/media/images/ascending-arrow.gif' : ''}"  border="0"/>
                        <t:graphicImage  value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='currenciesDTO-name') ? '/app/media/images/descending-arrow.gif' :''}"  border="0"/>
                    </t:commandLink>
