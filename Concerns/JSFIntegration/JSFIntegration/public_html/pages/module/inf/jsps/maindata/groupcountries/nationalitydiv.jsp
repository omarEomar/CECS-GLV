...
<t:panelGroup forceId="true" id="divEditLookup" >
    ...
    <h:panelGrid columns="1" rendered="#{pageBeanName.showEdit}" width="100%">
        <h:panelGrid columns="2" border="0" rowClasses="row02,row01" width="100%">
            ...
            <h:panelGroup>
                <h:inputText id="NameEdit" value="#{pageBeanName.nationalityDivDTO == null ? '' : pageBeanName.nationalityDivDTO.name}" styleClass="textboxlarge" maxlength="#{pageBeanName.nameMaxLength}"
                                onblur="setFocusOnlyOnElement('SaveButtonEdit');"/>
                <h:outputText value="*" styleClass="mandatoryAsterisk"/>
            </h:panelGroup>         
        </h:panelGrid>
        
        <t:panelGrid columns="3" border="0" align="center">
            <t:commandButton forceId="true" id="SaveButtonEdit" styleClass="cssButtonSmall" value="#{globalResources.SaveButton}" action="#{pageBeanName.saveNationality}" onclick="return validateInputText('myForm:NameEdit','myForm:clientErrorMessageEdit',null,null,null);"/>
