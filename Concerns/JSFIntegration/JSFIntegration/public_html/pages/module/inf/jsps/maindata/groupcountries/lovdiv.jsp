        ...
        <htm:tr>
            <htm:td align="center">
                <htm:table border="0" width="99%" id="lovtable5" cellspacing="0" cellpadding="0">
                    <htm:tr>
                        <htm:td valign="bottom" width="19">
                         <htm:img border="0" src="#{shared_util.contextPath}/app/media/images/R-top.gif" width="19" height="16"/>
                        </htm:td>
                        <htm:td valign="bottom" style="background-repeat: repeat-x; background-position-y: bottom" styleClass="gtopbox"></htm:td>
                        <htm:td valign="bottom" width="12">
                         <htm:img border="0" src="#{shared_util.contextPath}/app/media/images/L-top.gif" width="12" height="16"/>
                        </htm:td>
                    </htm:tr>
                    <htm:tr>
                        ...
                        <htm:td valign="top" bgcolor="#FFFFFF" styleClass="paddingbox">
                           ...
                           <t:panelGroup>
                            ...
                            <t:selectOneRadio forceId="true" id="lov_searchRadioBtn" value="#{pageBeanName.lovBaseBean.searchTyp}" styleClass="divtext" onblur="setFocusOnlyOnElement('lov_searchText');">
                            ...
                            <t:panelGrid align="center" columns="4" width="50%" forceId="true" id="lov_searchPanel">
                             <t:inputText forceId="true" id="lov_searchText"  value="#{pageBeanName.lovBaseBean.searchQuery}" styleClass="textboxmedium" onkeypress="FireButtonClick('myForm:lov_search_btn');"/>
                             <t:panelGroup>
                              <h:commandButton type="button" id="lov_search_btn" onclick="if(validateCodeNameSrchParamter('lov_searchRadioBtn','lov_searchText','','errorMessag_lov')){ lov_search();}" styleClass="ManyToManySearchButton" />
                                    <a4j:jsFunction name="lov_search" id="lov_search" action="#{pageBeanName.lovBaseBean.searchLovDiv}" reRender="lov_dataT_data_panel,lov_searchPanel,errorMessag_lov,lov_paging_panel,lovDiv_btnsPnlGrd"  oncomplete="setFocusOnlyOnElement('lov_searchText');"/>
                             </t:panelGroup>
                             <f:verbatim>&nbsp;&nbsp;</f:verbatim>
                             <a4j:commandButton id="lov_cancelSearch" action="#{pageBeanName.lovBaseBean.cancelSearchLovDiv}" reRender="lov_searchText,lov_dataT_data_panel,lov_searchPanel,errorMessag_lov,lov_paging_panel,lov_searchRadioBtn"  styleClass="ManyToManyCancelSearchButton" rendered="#{pageBeanName.lovBaseBean.searchMode}" oncomplete="setFocusOnlyOnElement('lov_searchText');"/>
                            </t:panelGrid>
    ...
    <t:panelGroup forceId="true" id="lov_dataT_data_panel" styleClass="lovDivScroll">
       ...
       <%--
          ...
          <t:column id="check_lov_column" styleClass="standardTable_Header3" width="5%" >
                <f:facet name="header">
                  <t:selectBooleanCheckbox forceId="true" id="checkAllLov" value="#{pageBeanName.lovBaseBean.checkAllFlag}">
            ...
            <t:column  sortable="false"  width="20%">
                <f:facet name="header">
                 <t:commandLink id="sort_code" forceId="true" styleClass="headerLink" value="#{resourcesBundle.INF_CountriesDTO_code_key}" onclick="return false;">                         
                 </t:commandLink>
                </f:facet>
                <h:outputText id="content_code" value="#{pageBeanName.lovBaseBean.keyIndex==null? list.code.key:list.code.keys[pageBeanName.lovBaseBean.keyIndex]}"/>
            </t:column>
            
            <t:column  sortable="false" width="75%">
                <f:facet name="header">
                 <t:commandLink id="sort_name" forceId="true" styleClass="headerLink" value="#{resourcesBundle.INF_CountriesDTO_name}" onclick="return false;">
                 </t:commandLink>                   
                </f:facet>
...
<t:panelGroup forceId="true" id="lov_paging_panel">
        <h:panelGrid id="lov_panelGrd_scroller" columns="1" dir="#{shared_util.pageDirection}" styleClass="scroller" width="300px" rendered="#{pageBeanName.lovBaseBean.listSize > shared_util.noOfTableRows}" >
          ...
          <t:dataScroller id="lov_scroll_1" 
                    fastStep="5" pageCountVar="pageCount" actionListener="#{pageBeanName.lovBaseBean.openLovDiv}" binding="#{pageBeanName.lovBaseBean.dataScroller}"
         ...
         <t:inputHidden forceId="true" id="pageIndexLov" value="#{pageBeanName.lovBaseBean.pageIndexLov}" rendered="#{pageBeanName.lovBaseBean.listSize > shared_util.noOfTableRows}" />
...
<%-- edit by i.elnahrawy -   issue no   HR-701  10. 010.gif add disable  --%>
 <t:commandButton id="lov_ok" value="#{globalResources.ok}" action="#{pageBeanName.lovBaseBean.closeLovDiv}" styleClass="cssButtonSmall"  disabled="#{empty pageBeanName.lovBaseBean.selectedDTOS}"/>
<%--a4j:commandButton id="lov_cancel" value="#{globalResources.back}" action="#{pageBeanName.lovBaseBean.hideLovDiv}" styleClass="cssButtonSmall" oncomplete="hideLookUpDiv(window.blocker,window.divLov)" reRender="lovDiv_btnsPnlGrd"
...
<t:panelGroup>
    <t:commandButton forceId="true" id="lov_cancel" value="#{globalResources.back}" styleClass="cssButtonSmall" 
                    onclick="cancelLovDiv();" onblur=" setFocusOnlyOnElement('lov_searchText');"/>
    <a4j:jsFunction name="cancelLovDiv"  action="#{pageBeanName.lovBaseBean.hideLovDiv}" oncomplete="hideLookUpDiv(window.blocker,window.divLov)" reRender="lovDiv_btnsPnlGrd"/>
</t:panelGroup>
 <%--h:commandButton id="lov_cancel" type="button" value="#{globalResources.back}" onclick="hideLookUpDiv(window.blocker,window.divLov);" styleClass="cssButtonSmall"/--%>
</t:panelGrid>
