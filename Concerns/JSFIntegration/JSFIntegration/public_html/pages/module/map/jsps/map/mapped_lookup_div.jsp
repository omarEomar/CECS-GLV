...
<table border="0" width="99%" id="table5" cellspacing="0" cellpadding="0"></f:verbatim>
    <f:verbatim><tr></f:verbatim>
        <f:verbatim><td valign="bottom" width="19"></f:verbatim>
            <f:verbatim><img border="0" src="${shared_util.contextPath}/app/media/images/R-top.gif" width="19" height="16"></td></f:verbatim>
                <f:verbatim><td valign="bottom" style="background-repeat: repeat-x; background-position-y: bottom" class="gtopbox">&nbsp;</td></f:verbatim>
                    <f:verbatim><td valign="bottom" width="12"></f:verbatim>
                        <f:verbatim><img border="0" src="${shared_util.contextPath}/app/media/images/L-top.gif" width="12" height="16"></td></f:verbatim>
                            <f:verbatim></tr></f:verbatim>
                                <f:verbatim><tr></f:verbatim>
                                    <f:verbatim><td valign="top" style="background-image: url('${shared_util.contextPath}/app/media/images/g-r.gif'); background-repeat: repeat-y" class="grightbox">&nbsp;</td></f:verbatim>
                                        ...
                                        <t:outputText id="clientErrorMessage" styleClass="errMsg" forceId="true"/>
                                                ...
                                                <t:inputText forceId="true" id="Name" value="#{pageBeanName.searchString}" styleClass="textboxlarge" onblur="setFocusOnlyOnElement('myForm:searchAdd');" onkeypress="FireButtonClick('myForm:searchAdd');"/>
                                                <h:outputLabel value="" />
                                                </h:panelGroup>
                                                ...
                                                <a4j:commandButton action="#{pageBeanName.searchAvailable}" reRender="dataT_available,panelGrd_scrolleradd,srchContianer,divAdd,btnContiner"  value=""  styleClass="MapSearchButton" id="searchAdd"/>
                                                <a4j:commandButton binding="#{pageBeanName.cancelSearchBtn}" action="#{pageBeanName.cancelSearchAvailable}" reRender="dataT_available,panelGrd_scrolleradd,srchContianer,divAdd,btnContiner" value="" styleClass="MapCancelSearchButton" rendered="false"  oncomplete="checkAllCheckBoxDiv('chk2','listSize','checkAll','pageIndexMap','noOfTableRow');"/>
                                                </t:panelGroup>
                                                
                                        <f:verbatim></td></f:verbatim>
                                    <f:verbatim><td valign="top" style="background-repeat: repeat-y" class="gleftbox">&nbsp;</td></f:verbatim>
                                <f:verbatim></tr></f:verbatim>
                            <f:verbatim><tr></f:verbatim>
                    <f:verbatim><td valign="top" width="19"></f:verbatim>
                    <f:verbatim><img border="0" src="${shared_util.contextPath}/app/media/images/R-bottom.gif" width="19" height="11"></td></f:verbatim>
                <f:verbatim><td valign="top" style="background-repeat: repeat-x" class="gbottombox">&nbsp;</td></f:verbatim>
            <f:verbatim><td valign="top"></f:verbatim>
            <f:verbatim><img border="0" src="${shared_util.contextPath}/app/media/images/L-bottom.gif" width="12" height="11"></td></f:verbatim>
        <f:verbatim></tr></f:verbatim>
...
<h:panelGrid columns="1" rendered="#{ pageBeanName.listSize == 0 }">
 ...
 <t:panelGroup  styleClass="delDivScroll">
