...
<f:verbatim><br/></f:verbatim>
    ...
    <t:panelGroup forceId="true" id="salElementTypePnlGrp">
        ...
        <t:inputText value="sheka" onfocus="if(isVisibleComponent('customDiv1')){document.getElementById('salElementType').focus();}" forceId="true" id="fakeInput" styleClass="fakeInputForFocus"/>
         <t:selectOneMenu forceId="true" id="salElementType" styleClass="Dropdownbox" value="#{pageBeanName.salElementType}" converter="javax.faces.Long">
...
<t:panelGroup forceId="true" id="customDiv1PnlGrp" styleClass="delDivScroll" style="height:200px;width:100%">
    <t:dataTable id="dataT_customDiv1" var="list"
                     value="#{pageBeanName.benifitsAndRewardsList}" preserveDataModel="false"
                     renderedIfEmpty="false" 
                     footerClass="grid-footer" sortable="false"
                     styleClass="grid-footer"
                     headerClass="standardTable_Header"
                     rowClasses="standardTable_Row1,standardTable_Row2"
                     columnClasses="standardTable_ColumnCentered,standardTable_ColumnCentered,standardTable_ColumnCentered,standardTable_ColumnCentered,standardTable_ColumnCentered" width="100%" align="center"
                     rowIndexVar="index"
                     >
...
<t:commandButton forceId="true" id="backButtonCustomDiv1" type="button" onblur="if(isVisibleComponent('customDiv1')){document.getElementById('fakeInput').focus();}" value="#{globalResources.back}" onclick="hideSalElementTypeCombo();hideLookUpDiv(window.blocker,window.customDiv1,null,null);" styleClass="cssButtonSmall" />
