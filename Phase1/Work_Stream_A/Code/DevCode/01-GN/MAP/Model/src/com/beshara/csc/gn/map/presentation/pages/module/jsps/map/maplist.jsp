...
<%-- <a4j:log popup="false" level="ALL"  height="400" width="800"></a4j:log>--%>
    ...
    <t:saveState value="#{mappedDataBean.divBackBean.javaScriptCaller}" />
    ...
    <t:saveState value="{pageBeanName.displayTreeFlag}" />
    ...
    <%-- a4j:log hotkey="M" /--%>
     ...
     <t:saveState value="#{pageBeanName.selectedDTOS}"/>
      ...
      <t:saveState value="#{mappedDataBean.firstRelationType}"/>
      <t:saveState value="#{mappedDataBean.secondRelationType}"/>
     <t:saveState value="#{mappedDataBean.relationTypeCode}"/>
     
    
     
     <t:messages/>    
    <tiles:insert definition="mapped_data.page" flush="false">
          <tiles:put name="titlepage" type="string" value="mapped_title"/>
          ...
          <script type="text/javascript">
            ...
            fixDelDivProblem();
            function fixDelDivProblem(){
                try{
                    var objSpan = document.getElementById("divDeleteConfirm")
                if(objSpan.innerHTML == ""){
                  hideLookUpDiv(window.blocker,window.delConfirm,null,null);setFocusOnlyOnElement('objectType');  
                }    
                }catch(exception){
