 ...
 * @since 03/09/2007
 */
public interface ISocietiesClient extends IBasicClient {
    /** 
     ...
     */
    List<IBasicDTO> listByObjectType(Long objtypeCode) throws DataBaseException, 
    ...
    public List<IBasicDTO> searchByNameAndStatus(String name , String SystemOrCenterFlag) throws DataBaseException, SharedApplicationException ;
}
