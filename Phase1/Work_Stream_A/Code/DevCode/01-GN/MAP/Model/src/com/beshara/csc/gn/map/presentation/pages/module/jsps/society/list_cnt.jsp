...
<t:panelGrid border="0" cellpadding="0" cellspacing="0" width="100%">
    <t:panelGroup forceId="true" id="dataT_data_panel" styleClass="dataT-With-1-row-filter">
        ...
        <t:dataTable id="dataT_data" var="list"
            ...
            <t:column id="code_column" sortable="false" width="8%" rendered="#{(pageBeanName.selectedTypeCode != '1')}">
                <f:facet name="header">
            ...
            <t:column id="minCode_column" sortable="false" width="8%" rendered="#{(pageBeanName.selectedTypeCode == '1')}">
                <f:facet name="header">
                    <t:commandLink id="sort_minCode" forceId="true" styleClass="headerLink" value="#{globalResources.Code}"
                                   actionListener="#{pageBeanName.sortDataTable}">
                        <t:graphicImage value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='minCode') ? '/app/media/images/ascending-arrow.gif' :''}"
                                        border="0"/>
                        <t:graphicImage value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='minCode') ? '/app/media/images/descending-arrow.gif' :''}"
                                        border="0"/>
                    </t:commandLink>
                </f:facet>
                   <h:outputText id="content_minCode" value="#{list.minCode}"/>
            </t:column>
            <t:column id="name_column" sortable="false" width="72%">
                <f:facet name="header">
            ...
            <t:column id="societiesStatus_column" sortable="false" width="20%">
                <f:facet name="header">
                    <t:commandLink id="sort_societiesStatus" forceId="true" styleClass="headerLink" value="#{globalResources.type}"
                                   actionListener="#{pageBeanName.sortDataTable}">
                        <t:graphicImage value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='societiesStatus') ? '/app/media/images/ascending-arrow.gif' : ''}"
                                        border="0"/>
                        <t:graphicImage value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='societiesStatus') ? '/app/media/images/descending-arrow.gif' :''}"
                                        border="0"/>
                    </t:commandLink>
                </f:facet>
                <h:outputText id="content_societiesStatus" value="#{resourcesBundle.ministry}" rendered="#{list.societiesStatus == 1}" />
                <h:outputText id="content_societiesSystem" value="#{resourcesBundle.system }" rendered="#{list.societiesStatus == 2}"/>
