                    ...
                    <htm:tr>
                        ...
                        <htm:td valign="top" bgcolor="#FFFFFF" styleClass="paddingbox">
                           ...
                           <t:panelGroup>
                            ...
                            <t:selectOneRadio tabindex="1" forceId="true" id="lov_searchRadioBtn" value="#{pageBeanName.lovBaseBean.searchTyp}" styleClass="divtext" onkeydown="onKeyDownFirstElement(event,'lov_searchText','lov_cancel')" >
...
<t:panelGroup>
    <t:commandButton tabindex="5" forceId="true" id="lovDivOkTBtn" binding="#{pageBeanName.lovBaseBean.okBtnLovDiv}" disabled="true" value="#{globalResources.ok}" type="button" styleClass="cssButtonSmall" onclick="clearOutputText('errorMessag_lov'); return searchLovFunName();">
      <a4j:jsFunction name="searchLovFunName" action="#{pageBeanName.lovBaseBean.closeLovDiv}" 
      oncomplete="#{pageBeanName.lovBaseBean.onCompleteList};fillInputTextFilter(event,'#{pageBeanName.lovBaseBean.selectedDTOS[0].code.key}');"
      reRender="objectType,objectTypeText"/>
    </t:commandButton>
</t:panelGroup>
...
<script type="text/javascript">
  ...
  function fillInputTextFilter(e,txt){
      try{
      filterationDropboxOnChange(e,'objectType','objectTypeText','errorCodeId1',objectTypeChange);
      }catch(Exception ){
           document.getElementById('objectTypeText').value=txt;
      }
