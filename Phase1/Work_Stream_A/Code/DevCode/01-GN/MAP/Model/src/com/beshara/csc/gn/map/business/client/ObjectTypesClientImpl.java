 ...
 * @since 03/09/2007
 */
public class ObjectTypesClientImpl extends BaseClientImpl3 implements IObjectTypesClient {
    public ObjectTypesClientImpl() {
    }

    @Override
    protected Class<? extends BasicSession> getSessionInterface() {
        return ObjectTypesSession.class;
    }

    @Override
    protected ObjectTypesSession SESSION() {
        return (ObjectTypesSession)super.SESSION();
    }
    ...
    public List<IBasicDTO> getObjectTypeSearchCrieteria(String searchQuery,
        ...
        try {
            return SESSION().getObjectTypeSearchCrieteria(RI(), searchQuery, searchType);
        } catch (SharedApplicationException e) {
            throw e;
        } catch (Exception e) {
            throw getWrappedException(e);
