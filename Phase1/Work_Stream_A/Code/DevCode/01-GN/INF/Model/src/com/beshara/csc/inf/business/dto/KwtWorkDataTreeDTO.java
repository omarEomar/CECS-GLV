...
public class KwtWorkDataTreeDTO extends TreeDTO implements IKwtWorkDataTreeDTO {
    ...
    public KwtWorkDataTreeDTO() {
    }

    public KwtWorkDataTreeDTO(KwtWorkDataEntity kwtWorkDataEntity) {
        if (kwtWorkDataEntity != null) {
            ...
            if (kwtWorkDataEntity.getMinCode() != null && kwtWorkDataEntity.getWrkCode() != null &&
                !kwtWorkDataEntity.getWrkCode().equals("")) {
                IWorkCentersEntityKey entityKey =
                    OrgEntityKeyFactory.createWorkCentersEntityKey(kwtWorkDataEntity.getMinCode(),
        ...
        if (getFromDate() != null && getServiceYears() == 0 && getServiceMonths() == 0 && getServiceDays() == 0) {
            calcServiceDaysPerRow();
        }
        if (kwtWorkDataEntity.getJobHistoryStatus() != null) {
            this.setJobHistoryStatus(kwtWorkDataEntity.getJobHistoryStatus());
    }
    }

    private void calcServiceDaysPerRow() {
        if (getMinistriesDTO().getCatsDTO().getGovFlag().equals(1L) ||
            (getActualExpYears() == null && getActualExpDays() == null && getActualExpMonths() == null)) {
            ...
            setServiceDays(getActualExpDays().intValue());
            setServiceMonths(getActualExpMonths().intValue());
            setServiceYears(getActualExpYears().intValue());
        }
    }
