...
<t:panelGrid width="100%" columns="4" align="center" rowClasses="row01,row02" cellpadding="0" cellspacing="0">
    ...
    <t:panelGroup>
        <t:selectOneMenu id="bookTypesListID" forceId="true" styleClass="DropdownboxLarge"
                         value="#{pageBeanName.selectedCatCode}" converter="javax.faces.Long">
            <f:selectItem itemValue="#{pageBeanName.virtualLongValue}" itemLabel="#{resourcesBundle.select_one_item}"/>
            <t:selectItems value="#{pageBeanName.groupCategoryList}" var="groupCategoryList"
