 ...
 * @since 03/09/2007
 */
public class KwStreetsClientImpl extends BaseClientImpl3 implements IKwStreetsClient {

    /**
     * @param KwStreetsSession
     */
    public KwStreetsClientImpl() {
    }

    @Override
    protected Class<? extends BasicSession> getSessionInterface() {
        return KwStreetsSession.class;
    }

    @Override
    protected KwStreetsSession SESSION() {
        return (KwStreetsSession)super.SESSION();
    }
