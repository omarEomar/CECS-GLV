...
<t:panelGrid border="0" cellpadding="0" cellspacing="0" width="100%">
    <t:panelGroup forceId="true" id="dataT_data_panel">
        ...
        <t:dataTable id="dataT_data" var="list"
            ...
            <t:column id="errCode_column" sortable="false" width="8%">
                <f:facet name="header">
                    <t:commandLink id="sort_errCode" forceId="true" styleClass="headerLink"
                                   value="#{globalResources.Code}" actionListener="#{pageBeanName.sortDataTable}">
                        <t:graphicImage value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='errCode') ? '/app/media/images/ascending-arrow.gif' :''}"
                                        border="0"/>
                        <t:graphicImage value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='errCode') ? '/app/media/images/descending-arrow.gif' :''}"
                                        border="0"/>
                    </t:commandLink>
                </f:facet>
                <h:outputText id="content_code" value="#{list.errCode}"/>
            </t:column>
            <t:column id="name_column" sortable="false" width="43%">
                <f:facet name="header">
                    <t:commandLink id="sort_errAMsg" forceId="true" styleClass="headerLink"
                                   value="#{resourcesBundle.orcale_errors_err_a_msg_cnt}"
                                   actionListener="#{pageBeanName.sortDataTable}">
                        <t:graphicImage value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='errAMsg') ? '/app/media/images/ascending-arrow.gif' : ''}"
                                        border="0"/>
                        <t:graphicImage value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='errAMsg') ? '/app/media/images/descending-arrow.gif' :''}"
                                        border="0"/>
                    </t:commandLink>
                </f:facet>
                <h:outputText id="content_errAMsg" value="#{list.errAMsg}"/>
            </t:column>
            <t:column id="errEMsg" sortable="false" width="43%">
                <f:facet name="header">
                    <t:commandLink id="sort_errEMsg" forceId="true" styleClass="headerLink"
                                   value="#{resourcesBundle.orcale_errors_err_e_msg_cnt}"
                                   actionListener="#{pageBeanName.sortDataTable}">
                        <t:graphicImage value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='errEMsg') ? '/app/media/images/ascending-arrow.gif' : ''}"
                                        border="0"/>
                        <t:graphicImage value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='errEMsg') ? '/app/media/images/descending-arrow.gif' :''}"
                                        border="0"/>
                    </t:commandLink>
                </f:facet>
                <h:outputText id="content_errEMsg" value="#{list.errEMsg}"/>
            </t:column>
        </t:dataTable>
