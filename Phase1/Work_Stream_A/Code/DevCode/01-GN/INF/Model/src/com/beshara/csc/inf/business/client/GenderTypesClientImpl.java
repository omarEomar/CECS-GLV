 ...
 * @since 03/09/2007
 */
public class GenderTypesClientImpl extends BaseClientImpl3 implements IGenderTypesClient {


    public GenderTypesClientImpl() {
        super();
    }

    @Override
    protected Class<? extends BasicSession> getSessionInterface() {
        return GenderTypesSession.class;
    }

    @Override
    protected GenderTypesSession SESSION() {
        return (GenderTypesSession)super.SESSION();
    }
