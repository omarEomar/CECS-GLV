...
import com.beshara.csc.inf.business.deploy.OracleErrorsSession;
 ...
 * @since 03/09/2007
 */
public class OracleErrorsClientImpl extends BaseClientImpl3 implements IOracleErrorsClient {

    /**
     * @param OracleErrorsSession
     */
    public OracleErrorsClientImpl() {
    }

    @Override
    protected Class<? extends BasicSession> getSessionInterface() {
        return OracleErrorsSession.class;
    }

    @Override
    protected OracleErrorsSession SESSION() {
        return (OracleErrorsSession)super.SESSION();
    }
