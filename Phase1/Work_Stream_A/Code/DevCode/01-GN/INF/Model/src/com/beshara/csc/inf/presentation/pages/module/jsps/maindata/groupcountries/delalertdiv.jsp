...
<t:panelGrid columns="1" width="100%">
    <t:panelGroup forceId="true" id="divDeleteAlert" styleClass="delDivScroll">
        <t:dataTable id="dataT_Delete" var="list" value="#{pageBeanName.selectedDTOS}" preserveDataModel="false" renderedIfEmpty="false" footerClass="grid-footer" sortable="false"
            ...
            <t:column width="75%" defaultSorted="true">
                <f:facet name="header">
                    <h:outputText id="name" value="#{resourcesBundle.cntryName}"/>
                </f:facet>
                <h:outputText id="popup_name" value="#{list.countriesDTO.name}"/>
            </t:column>
        </t:dataTable>
    </t:panelGroup>
    ...
    <t:panelGrid columns="2" align="center">
        ...
        <t:commandButton forceId="true" id="OkButtonDelAlertDiv" onkeydown="onKeyDownFirstElement(event,'CancelButtonDelAlertDiv',null);" styleClass="cssButtonSmall" value="#{globalResources.ok}" action="#{pageBeanName.deleteDiv}"/>
        <t:commandButton forceId="true" id="CancelButtonDelAlertDiv" onkeydown="onKeyDownLastElement(event,null,'OkButtonDelAlertDiv');" styleClass="cssButtonSmall" value="#{globalResources.cancel}" onclick="hideLookUpDiv(window.blocker,window.delAlert,null,null); return false;"/>
