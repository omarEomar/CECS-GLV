...
import com.beshara.csc.inf.business.deploy.MilitaryStatusSession;
 ...
 * @since 03/09/2007
 */
public class MilitaryStatusClientImpl extends BaseClientImpl3 implements IMilitaryStatusClient {
    public MilitaryStatusClientImpl() {
    }

    @Override
    protected Class<? extends BasicSession> getSessionInterface() {
        return MilitaryStatusSession.class;
    }

    @Override
    protected MilitaryStatusSession SESSION() {
        return (MilitaryStatusSession)super.SESSION();
    }
