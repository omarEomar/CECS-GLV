...
<f:view locale="#{shared_util.locale}">
    <h:form id="myForm" binding="#{systemSettingBean.frm}">
        <f:loadBundle basename="com.beshara.csc.inf.presentation.resources.inf" var="resourcesBundle"/>
        <t:aliasBean alias="#{pageBeanName}" value="#{systemSettingBean}">
            <tiles:insert flush="false" definition="systemSettingBean.page">
                <t:saveState value="#{systemSettingBean.pageMode}"/>    
            </tiles:insert>
        </t:aliasBean>
        ...
        <script type="text/javascript">
            ...
            function foucsAddbuttonOnList(){
             ...
             function settingFoucsAtDivAdd() {
              if (document.getElementById('syssettingName') != null) {
                  document.getElementById('syssettingName').focus();
              }
          }
