...
<t:panelGroup forceId="true" id="divEditLookup" >
    ...
    <h:panelGrid columns="1" rendered="#{pageBeanName.showEdit}" width="100%">
        <h:panelGrid columns="2" border="0" rowClasses="row02,row01" cellpadding="3" cellspacing="0" width="100%">
            ...
            <h:panelGroup>
                <t:inputText id="currNameEdit" value="#{pageBeanName.selectedPageDTO.aprmakerName}" styleClass="textboxlarge" maxlength="#{pageBeanName.nameMaxLength}" forceId="true"/>
                <h:outputText value="*" styleClass="mandatoryAsterisk"/>
                <c:requiredFieldValidator componentToValidate="currNameEdit" display="dynamic" errorMessage="#{globalResources.missingField}" highlight="false" active="#{approvalMakersBean.pageMode==2}"/>
            </h:panelGroup>         
            
            <t:outputText value="#{resourcesBundle.approval_makers_status}"  styleClass="lable01"/>
            <t:panelGroup>
              <h:selectOneRadio value="#{pageBeanName.selectedPageDTO.dynamicFlag}"    styleClass="lable01">
        ...
        <t:panelGrid columns="3" border="0" align="center">
            ...
            <t:commandButton forceId="true" id="CancelButtonEdit" styleClass="cssButtonSmall" value="#{globalResources.back}" onblur="settingFoucsAtDivEdit();"  />
                <a4j:jsFunction name="cancelEditJs" action="#{pageBeanName.cancelEdit}" oncomplete="hideLookUpDiv(window.blocker,window.lookupEditDiv,'currNameEdit','myForm:errorEdit');foucsAddbuttonOnList();" reRender="scriptPanelGroup"/>
            </t:panelGroup>
        </t:panelGrid>
    </h:panelGrid>
</t:panelGroup>
