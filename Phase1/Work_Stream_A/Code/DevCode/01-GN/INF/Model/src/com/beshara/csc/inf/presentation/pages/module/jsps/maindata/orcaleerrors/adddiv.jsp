...
<t:panelGroup forceId="true" id="divAddLookup">
    ...
    <t:panelGrid columns="2" border="0" styleClass="row01" width="100%" rowClasses="row01,row02" cellpadding="0"
        ...
        <t:panelGroup>
            <t:inputText maxlength="#{pageBeanName.nameMaxLength}" id="errAMsg1" value="#{pageBeanName.pageDTO.errAMsg}"
                         styleClass="textboxlarge" forceId="true"/>
            <h:outputText value="*" styleClass="mandatoryAsterisk"/>
            <c:requiredFieldValidator componentToValidate="errAMsg1" display="dynamic"
                                      errorMessage="#{globalResources.missingField}" highlight="false"
                                      active="#{orcaleErrorsBean.pageMode==1}"/>
        </t:panelGroup>
        <t:outputText value="#{resourcesBundle.orcale_errors_err_e_msg}" styleClass="lable01"/>
        <t:panelGroup>
            <t:inputText id="errEMsg1" value="#{pageBeanName.pageDTO.errEMsg}" styleClass="textboxlarge"
                         forceId="true"/>
            <h:outputText value=""/>
        </t:panelGroup>
    </t:panelGrid>
...
<t:panelGrid columns="3" border="0" align="center">
    ...
    <h:panelGroup>
        ...
        <a4j:jsFunction name="saveAndNew" action="#{pageBeanName.saveAndNew}" reRender="divAddLookup"
                        oncomplete="setFocusOnlyOnElement('errAMsg1');"/>
    </h:panelGroup>
    <h:panelGroup>
        ...
        <a4j:jsFunction name="backJsFunction" action="#{pageBeanName.cancelAdd}"
                        oncomplete="hideLookUpDiv(window.blocker,window.lookupAddDiv,'myForm:errAMsg','myForm:error','add',);foucsAddbuttonOnList();"
