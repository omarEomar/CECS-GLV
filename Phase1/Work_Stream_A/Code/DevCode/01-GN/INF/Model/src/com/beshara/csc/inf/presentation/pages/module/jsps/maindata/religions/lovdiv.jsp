...
<t:panelGroup forceId="true" id="lovLinkPanel" > 

    <htm:table border="0" cellpadding="0" cellspacing="0" width="100%" ><htm:tr>
                    
                    <htm:td align="center"  >
                     <t:panelGrid id="titleID" forceId="true" styleClass="TitlePage"  rendered="#{pageBeanName.lovBaseBean.listSize > 0}" >
                      <t:outputText  value="#{resourcesBundle.genderReligionView}" />
                      </t:panelGrid>
                    </htm:td>
                  </htm:tr>
        <htm:tr>
                       ...
                       <%--
                           <t:column id="check_column" styleClass="standardTable_Header3" width="5%">
                            ...
                            <t:column  sortable="false" width="75%">
                                ...
                                <h:outputText id="content_name" value="#{list.genregName}"/>
                            </t:column>
                        </t:dataTable>
                        <t:panelGrid columns="1" rendered="#{pageBeanName.lovBaseBean.listSize == 0 }" styleClass="noResMsg" align="center">
