 ...
 */
@Remote
public interface NewspapersSession extends BasicSession { // Add your extra methods

    public List<INewspapersDTO> getCodeName(IRequestInfoDTO ri) throws RemoteException, DataBaseException,
