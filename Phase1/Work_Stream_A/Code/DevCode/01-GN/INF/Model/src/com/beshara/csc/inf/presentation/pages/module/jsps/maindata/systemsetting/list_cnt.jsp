...
<t:panelGrid border="0" cellpadding="0" cellspacing="0" width="100%">
    <t:panelGroup forceId="true" id="dataT_data_panel">
        ...
        <t:dataTable id="dataT_data" var="list"
                     ...
                     rowOnDblClick="javascript:rowOnDblClickJs('chk',#{index});" forceIdIndexFormula="#{list.code.key}"
            ...
            <t:column id="name_column" sortable="false" width="70%">
                <f:facet name="header">
                    <t:commandLink id="sort_syssettingName" forceId="true" styleClass="headerLink"
                                   value="#{resourcesBundle.system_setting_name}"
                                   actionListener="#{pageBeanName.sortDataTable}">
                        <t:graphicImage value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='syssettingName') ? '/app/media/images/ascending-arrow.gif' : ''}"
                                        border="0"/>
                        <t:graphicImage value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='syssettingName') ? '/app/media/images/descending-arrow.gif' :''}"
                                        border="0"/>
                    </t:commandLink>
                </f:facet>
                <h:outputText id="content_syssetting_Name" value="#{list.syssettingName}"/>
            </t:column>
            <t:column id="system_setting_amount_column" sortable="false" width="15%">
                <f:facet name="header">
                    <t:commandLink id="sort_syssettingValue" forceId="true" styleClass="headerLink"
                                   value="#{resourcesBundle.system_setting_amount}"
                                   actionListener="#{pageBeanName.sortDataTable}">
                        <t:graphicImage value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='syssettingValue') ? '/app/media/images/ascending-arrow.gif' : ''}"
                                        border="0"/>
                        <t:graphicImage value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='syssettingValue') ? '/app/media/images/descending-arrow.gif' :''}"
                                        border="0"/>
                    </t:commandLink>
                </f:facet>
                <h:outputText id="content_syssetting_Value" value="#{list.syssettingValue}"/>
            </t:column>
        </t:dataTable>
