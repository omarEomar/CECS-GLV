...
import com.beshara.csc.inf.business.deploy.LanguagesSession;
 ...
 * @since 03/09/2007
 */
public class LanguagesClientImpl extends BaseClientImpl3 implements ILanguagesClient {

    /**
     * @param LanguagesSession
     */
    public LanguagesClientImpl() {
    }

    @Override
    protected Class<? extends BasicSession> getSessionInterface() {
        return LanguagesSession.class;
    }

    @Override
    protected LanguagesSession SESSION() {
        return (LanguagesSession)super.SESSION();
    }
