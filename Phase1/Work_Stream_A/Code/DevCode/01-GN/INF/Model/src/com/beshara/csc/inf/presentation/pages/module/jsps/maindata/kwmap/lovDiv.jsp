                    ...
                    <htm:tr>
                        ...
                        <htm:td valign="top" bgcolor="#FFFFFF" styleClass="paddingbox">
                           ...
                           <t:panelGroup>
                            ...
                            <t:panelGrid align="center" style="text-align:center;" columns="2" width="50%" forceId="true" id="lov_searchPanel">
                            <t:outputText styleClass="lable01" value="#{pageBeanName.lovBaseBean.lovDivLabelSearch}" rendered="#{!empty pageBeanName.lovBaseBean.lovDivLabelSearch}"/>
                             <t:panelGroup >
                                    <t:inputText forceId="true" id="lov_searchText"  value="#{pageBeanName.lovBaseBean.searchQuery}" styleClass="textboxmedium"  onkeypress="if(document.getElementById('lov_search_btn') != null){ FireButtonClick('lov_search_btn');}else{FireButtonClick('lov_search_btn_code_string');}"/>
                                    ...
                                    <t:commandButton rendered="#{pageBeanName.lovBaseBean.codeTypeString}" type="button" id="lov_search_btn_code_string" forceId="true" onclick="lov_search();" styleClass="ManyToManySearchButton" />
                ...
                <t:panelGrid border="0" cellpadding="0" cellspacing="0" width="80%" align="center" >
                    <t:panelGroup forceId="true" id="lov_dataT_data_panel" styleClass="lovDivScroll5">
                       ...
                       <t:column id="check_column" styleClass="standardTable_Header3" width="5%" rendered="#{!pageBeanName.lovBaseBean.multiSelect}">
                        ...
                        <t:selectOneRadio styleClass="radioButton_DataTable"  id="chk1" value="#{pageBeanName.lovBaseBean.selectedRadio}" onkeyup="toggleRadioKeyUp(this);" onmousedown="toggleRadio(this);">
                         <f:selectItem itemLabel="" itemValue="#{list.code.key}" />
                         <a4j:support event="onclick"  actionListener="#{pageBeanName.lovBaseBean.selectedRadioButton}" oncomplete="if(document.getElementById('myForm')!=null){document.getElementById('myForm:lov_ok').disabled=false;document.getElementById('myForm:lov_ok').focus();document.getElementById('myForm:lov_ok').focus()}else{document.getElementById('treeForm:lov_ok').disabled=false;document.getElementById('treeForm:lov_ok').focus();document.getElementById('treeForm:lov_ok').focus()};" reRender="lovDiv_btnsPnlGrd"/>
                        </t:selectOneRadio>
                       </t:column> 
                        ...
                        <f:facet name="header">
                            ...
                            <t:selectBooleanCheckbox forceId="true" id="chk" value="#{list.checked}">
                                  <a4j:support event="onclick" actionListener="#{pageBeanName.lovBaseBean.selectedCheckboxs}"
                                               oncomplete="checkCheckAll('chk');document.getElementById('myForm:lov_ok').disabled=false;"
                            ...
                            <t:column  sortable="false"  width="20%">
                                ...
                                <t:outputText id="content_code" forceId="true" value="#{list.privateCode}"/>
                           </t:column>  
...
<t:panelGroup forceId="true" id="lov_paging_panel">
        <h:panelGrid id="lov_panelGrd_scroller" columns="1" dir="#{shared_util.pageDirection}" styleClass="scroller" width="300px" rendered="#{pageBeanName.lovBaseBean.listSize > shared_util.noOfTableRows}" >
          ...
          <t:dataScroller id="lov_scroll_1" 
                    ...
                    actionListener="#{pageBeanName.openLovDiv}">
                <f:facet name="first" >                            
...
<t:panelGroup>
    <t:commandButton id="lov_ok" disabled="true" value="#{globalResources.ok}" type="button" styleClass="cssButtonSmall" onclick="clearOutputText('errorMessag_lov'); return searchLovFunName();">
      <a4j:jsFunction name="searchLovFunName" action="#{pageBeanName.closeLovDiv}" oncomplete="#{pageBeanName.lovBaseBean.onCompleteList}" reRender="#{pageBeanName.lovBaseBean.renderedDropDown}"/>
    </t:commandButton>
</t:panelGroup>

<t:panelGroup>
    <t:commandButton onclick="clearOutputText('errorMessag_lov');" forceId="true" id="lov_cancel" onblur="settingFoucsAtLovDiv();" type="button" styleClass="cssButtonSmall" value="#{globalResources.back}"/>
    <a4j:support event="onclick"  oncomplete="hideLookUpDiv(window.blocker,window.divLov)" reRender="lovDiv_btnsPnlGrd,divSearch"/>
</t:panelGroup>
