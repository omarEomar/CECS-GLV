 ...
 * @since 03/09/2007
 */
public interface IFieldsClient extends IBasicClient {
    /**
     * @return List
     */
    public List<IBasicDTO> getCodeName() throws DataBaseException, SharedApplicationException;

    List<IBasicDTO> getRelatedFields(IEntityKey fieldCode) throws DataBaseException, SharedApplicationException;

    List<IFieldValueDTO> calculateFieldValue(IBasicDTO fldDTO, List params) throws DataBaseException,
                                                                                   SharedApplicationException;

    public List<IBasicDTO> getFieldWithRelatedFieldsValues(IBasicDTO fldDTO, String param) throws DataBaseException,
                                                                                                  SharedApplicationException;

    List<IBasicDTO> getFieldWithRelatedFieldsValues(List<IBasicDTO> relatedFields, IBasicDTO fldDTO,
                                                    String param) throws SharedApplicationException, DataBaseException;
}
