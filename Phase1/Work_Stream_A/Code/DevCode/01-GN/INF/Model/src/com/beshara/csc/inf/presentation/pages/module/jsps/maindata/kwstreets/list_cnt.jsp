...
<t:panelGrid border="0" cellpadding="0" cellspacing="0" width="100%">
    <t:panelGroup forceId="true" id="dataT_data_panel">
        ...
        <t:dataTable id="dataT_data" var="list"
            ...
            <t:column id="name_column" sortable="false" width="65%">
                <f:facet name="header">
                    <t:commandLink id="sort_name" forceId="true" styleClass="headerLink"
                                   value="#{resourcesBundle.kwStreets_Name}"
                                   actionListener="#{pageBeanName.sortDataTable}">
            ...
            <%-- <t:column id="cur_abrv_column" sortable="false" width="10%"> <f:facet name="header"> <t:commandLink
                 id="sort_kwStreets" forceId="true" styleClass="headerLink" value="#{resourcesBundle.holtypeDays}"
                 actionListener="#{pageBeanName.sortDataTable}"> <t:graphicImage
                 value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='holtypeDays') ?
                 ...
                 id="content_cur_abrv" value="#{list.holtypeDays}"/> </t:column>--%>
        </t:dataTable>
