 ...
 * @since 03/09/2007 
 */
public interface IRelatedFieldsClient extends IBasicClient {
    List<IBasicDTO> getReferncesByFLdCode(Long fldCode) throws DataBaseException,SharedApplicationException;
}
