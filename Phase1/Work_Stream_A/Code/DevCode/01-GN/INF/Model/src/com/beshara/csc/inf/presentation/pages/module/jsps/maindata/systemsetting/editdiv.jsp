...
<t:panelGroup forceId="true" id="divEditLookup" >
    ...
    <h:panelGrid columns="1" rendered="#{pageBeanName.showEdit}" width="100%">
        <h:panelGrid columns="2" border="0" rowClasses="row02,row01" cellpadding="3" cellspacing="0" width="100%">
            ...
            <h:panelGroup>
                <t:inputText id="currNameEdit" value="#{pageBeanName.selectedPageDTO.syssettingName}" styleClass="textboxlarge" maxlength="#{pageBeanName.nameMaxLength}" forceId="true"/>
                <h:outputText value="*" styleClass="mandatoryAsterisk"/>
                <c:requiredFieldValidator componentToValidate="currNameEdit" display="dynamic" errorMessage="#{globalResources.missingField}" highlight="false" active="#{systemSettingBean.pageMode==2}"/>
            </h:panelGroup>         
            
             <t:outputText value="#{resourcesBundle.system_setting_amount}"  styleClass="lable01"/>
            <t:panelGroup>
                <t:inputText id="syssettingValue1" value="#{pageBeanName.selectedPageDTO.syssettingValue}" styleClass="textboxlarge" maxlength="#{pageBeanName.nameMaxLength}" forceId="true" />
                <h:outputText value="*" styleClass="mandatoryAsterisk"/>
                <c:requiredFieldValidator componentToValidate="syssettingValue1" display="dynamic" errorMessage="#{globalResources.missingField}" highlight="false" active="#{systemSettingBean.pageMode==2}"/>
             </t:panelGroup>            
