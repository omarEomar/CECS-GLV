    ...
    <t:panelGroup forceId="true" id="dataT_data_panel">
        ...
        <t:dataTable id="dataT_data" var="list"
            ...
            <t:column id="name_column" sortable="false" width="50%">
                <f:facet name="header">
                    <t:commandLink id="sort_currencyName" forceId="true" styleClass="headerLink"
                                   value="#{resourcesBundle.currency_name}"
                                   actionListener="#{pageBeanName.sortDataTable}">
                        <t:graphicImage value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='currencyName') ? '/app/media/images/ascending-arrow.gif' : ''}"
                                        border="0"/>
                        <t:graphicImage value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='currencyName') ? '/app/media/images/descending-arrow.gif' :''}"
                                        border="0"/>
                    </t:commandLink>
                </f:facet>
                <h:outputText id="content_name" value="#{list.currencyName}"/>
            </t:column>
            <t:column id="cur_abrv_column" sortable="false" width="15%">
                <f:facet name="header">
                    <t:commandLink id="sort_currencyAbrv1" forceId="true" styleClass="headerLink"
                                   value="#{resourcesBundle.currency_abrv}"
                                   actionListener="#{pageBeanName.sortDataTable}">
                        <t:graphicImage value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='currencyAbrv1') ? '/app/media/images/ascending-arrow.gif' : ''}"
                                        border="0"/>
                        <t:graphicImage value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='currencyAbrv1') ? '/app/media/images/descending-arrow.gif' :''}"
                                        border="0"/>
                    </t:commandLink>
                </f:facet>
                <h:outputText id="content_cur_abrv" value="#{list.currencyAbrv1}"/>
            </t:column>
            
            <t:column id="cur_abrv_column_1" sortable="false" width="15%">
                <f:facet name="header">
                    <t:commandLink id="sort_currencyAbrv2" forceId="true" styleClass="headerLink"
                                   value="#{resourcesBundle.currency_abrv2}"
                                   actionListener="#{pageBeanName.sortDataTable}">
                        <t:graphicImage value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='currencyAbrv2') ? '/app/media/images/ascending-arrow.gif' : ''}"
                                        border="0"/>
                        <t:graphicImage value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='currencyAbrv2') ? '/app/media/images/descending-arrow.gif' :''}"
                                        border="0"/>
                    </t:commandLink>
                </f:facet>
                <h:outputText id="content_cur_abrv" value="#{list.currencyAbrv2}"/>
            </t:column>
