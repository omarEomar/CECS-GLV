...
<t:panelGrid border="0" cellpadding="0" cellspacing="0" width="100%">
    <t:panelGroup forceId="true" id="dataT_data_panel">
        ...
        <t:dataTable id="dataT_data" var="list"
                     ...
                     forceIdIndexFormula="#{list.code.key}" rowOnDblClick="javascript:rowOnDblClickJs('chk',#{index});"
            ...
            <t:column id="paperName" sortable="false" width="15%">
                <f:facet name="header">
                    <t:commandLink id="sort_paperName" forceId="true" styleClass="headerLink"
                                   value="#{globalResources.name}" actionListener="#{pageBeanName.sortDataTable}">
                        <t:graphicImage value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='paperName') ? '/app/media/images/ascending-arrow.gif' : ''}"
                                        border="0"/>
                        <t:graphicImage value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='paperName') ? '/app/media/images/descending-arrow.gif' :''}"
                                        border="0"/>
                    </t:commandLink>
                </f:facet>
                <h:outputText id="content_paperName" value="#{list.paperName}"/>
            </t:column>
            <t:column id="news_paper_location" sortable="false" width="15%">
                <f:facet name="header">
                    <t:commandLink id="sort_paperLocation" forceId="true" styleClass="headerLink"
                                   value="#{resourcesBundle.news_paper_location_text}"
                                   actionListener="#{pageBeanName.sortDataTable}">
                        <t:graphicImage value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='paperLocation') ? '/app/media/images/ascending-arrow.gif' : ''}"
                                        border="0"/>
                        <t:graphicImage value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='paperLocation') ? '/app/media/images/descending-arrow.gif' :''}"
                                        border="0"/>
                    </t:commandLink>
                </f:facet>
                <h:outputText id="paperLocation" value="#{list.paperLocation}"/>
            </t:column>
        </t:dataTable>
