...
<t:panelGrid border="0" cellpadding="0" cellspacing="0" width="100%">
    <t:panelGroup forceId="true" id="dataT_data_panel" styleClass="dataT-With-1-row-filter">
        ...
        <t:dataTable id="dataT_data" var="list" value="#{pageBeanName.usingPaging ? pageBeanName.pagingBean.myPagedDataModel : pageBeanName.myTableData}" rowStyleClass="#{ pageBeanName.selected ? 'standardTable_RowHighlighted' : null}"
            ...
            <!--   -->
            <t:column id="capitalFlag_name" sortable="false" width="15%">
                <f:facet name="header">

                    <t:commandLink id="sort_capitalFlag" forceId="true" styleClass="headerLink" value="#{resourcesBundle.INF_CountriesDTO_countryCitiesDTOList}" actionListener="#{pageBeanName.sortDataTable}">                         
                        <t:graphicImage  value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='capitalFlag') ? '/app/media/images/ascending-arrow.gif' : ''}"  border="0"/>
                        <t:graphicImage  value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='capitalFlag') ? '/app/media/images/descending-arrow.gif' :''}"  border="0"/>
                    </t:commandLink>
                   
                </f:facet>
                <t:graphicImage id="trueFlag" value="/module/media/images/true.png" border="0"
                               rendered="#{list.capitalFlag==1}"  />
