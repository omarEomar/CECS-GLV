 ...
 * @since 03/09/2007
 */
public class SystemSettingsClientImpl extends BaseClientImpl3 implements ISystemSettingsClient {

    /**
     * @param SystemSettingsSession
     */
    public SystemSettingsClientImpl() {

    }

    @Override
    protected Class<? extends BasicSession> getSessionInterface() {
        return SystemSettingsSession.class;
    }

    @Override
    protected SystemSettingsSession SESSION() {
        return (SystemSettingsSession)super.SESSION();
    }
