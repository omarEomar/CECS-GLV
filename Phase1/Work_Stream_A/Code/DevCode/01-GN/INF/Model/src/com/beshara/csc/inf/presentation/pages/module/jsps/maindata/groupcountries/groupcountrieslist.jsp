...
<f:view locale="#{shared_util.locale}">
    ...
    <h:form id="myForm" binding="#{groupCountriesListBean.frm}">
        ...
        <t:aliasBean alias="#{pageBeanName}" value="#{groupCountriesListBean}">
            <tiles:insert flush="false" definition="groupcountrieslist.page"></tiles:insert>
        </t:aliasBean>
        <script type="text/javascript">
          foucsAddbuttonOnList();
          function foucsAddbuttonOnList() {
              if (document.getElementById('countryCats') != null) {
                  document.getElementById('countryCats').focus();
              }
          }
        </script>
    </h:form>
