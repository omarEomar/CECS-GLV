...
<t:panelGroup forceId="true" id="divEditLookup">
    ...
    <h:panelGrid columns="1" rendered="#{pageBeanName.showEdit}" width="100%">
        <h:panelGrid columns="2" border="0" rowClasses="row02,row01" cellpadding="3" cellspacing="0" width="100%">
            ...
            <h:panelGroup>
                <t:inputText id="currNameEdit" value="#{pageBeanName.selectedPageDTO.name}" styleClass="textboxlarge"
                ...
                <c:requiredFieldValidator componentToValidate="currNameEdit" display="dynamic"
                                          ...
                                          active="#{religionsListBean.pageMode==2}"/>
            </h:panelGroup>
            <t:outputText value="#{resourcesBundle.maleReligionName}" styleClass="lable01"/>
            <t:panelGroup>
                <t:inputText id="male_religion_edit" value="#{pageBeanName.maleLinkEditDTO.genregName}"
            ...
            <t:panelGroup>
                <t:inputText id="female_religion_edit" value="#{pageBeanName.femaleLinkEditDTO.genregName}"
                             styleClass="textboxlarge" forceId="true"/>
                <h:outputText value="*" styleClass="mandatoryAsterisk"/>
