 ...
 */
@Remote
public interface HolidayTypesSession extends BasicSession {
    public List<IBasicDTO> getCodeName(IRequestInfoDTO ri) throws RemoteException, DataBaseException,
                                                                  SharedApplicationException;
    
    public List<IBasicDTO> getAllActiveHolidayTypes(IRequestInfoDTO ri) throws RemoteException, DataBaseException,
                                                                  SharedApplicationException;
}
