...
import com.beshara.csc.inf.business.deploy.RelatedFieldsSession;
import com.beshara.base.entity.IEntityKey;

import com.beshara.csc.inf.business.deploy.RelatedFieldsSessionBean;
 ...
 * @since 03/09/2007
 */
public class RelatedFieldsClientImpl extends BaseClientImpl3 implements IRelatedFieldsClient {
    private RelatedFieldsSession relatedFieldsSession;

    /** 
     * @param RelatedFieldsSession 
     */
    public RelatedFieldsClientImpl() {
        super();
    }
    @Override
    protected Class<? extends BasicSession> getSessionInterface() {
        return RelatedFieldsSession.class;
    }
    @Override
    protected RelatedFieldsSession SESSION() {
        return (RelatedFieldsSession)super.SESSION();
    }
    public List<IBasicDTO> getReferncesByFLdCode(Long fldCode) throws DataBaseException,SharedApplicationException {
            try {
                return SESSION().getReferncesByFLdCode(RI(),fldCode);
