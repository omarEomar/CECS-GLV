 ...
 */
@Remote
public interface SeekerLanguageSkillsSession extends BasicSession { // Add your extra methods

    public List<IBasicDTO> listAvailableEntities(IRequestInfoDTO ri, Long civilId) throws RemoteException,
                                                                                          DataBaseException,
