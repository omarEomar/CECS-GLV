...
public class CancelRegulationListBean extends ManyToManyDetailsMaintain {
    ...
    private static final String BACK_BEAN_NAME = "cancelRegulationListBean";
    ...
    public String cancelRegulation() {
        ...
        RegulationListBean regulationListBean = 
        ...
        try {
            ...
            regulationListBean.highlighDataTable(regulationListBean.BEAN_NAME);
