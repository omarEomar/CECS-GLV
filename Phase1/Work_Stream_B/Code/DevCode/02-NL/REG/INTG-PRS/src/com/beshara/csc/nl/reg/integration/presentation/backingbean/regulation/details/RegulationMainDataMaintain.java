...
import com.beshara.csc.nl.reg.integration.presentation.backingbean.regulation.EditorBean;
...
//                           null);
    ...
    public String getFakeImageString() {
        ...
        if(fakeImageString == null || (isInvalidImageType() || isUploadingError())){
            //            if(fakeImageString == null){
            fakeImageString = BeansUtil.getResource("com.beshara.csc.nl.reg.integration.presentation.resources.integration", "image_unAvailable");
            ...
            if (imageName != null && imageName.length() > 1) {
                fakeImageString = BeansUtil.getResource("com.beshara.csc.nl.reg.integration.presentation.resources.integration", "image_available");
            }
        }
        //        }
