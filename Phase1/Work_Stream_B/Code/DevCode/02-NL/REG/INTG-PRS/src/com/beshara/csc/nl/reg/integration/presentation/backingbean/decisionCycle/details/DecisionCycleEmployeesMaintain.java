...
import com.beshara.csc.nl.reg.integration.presentation.backingbean.decisionCycle.details.advanceSearch.AdvanceEmpSearch;
...
public class DecisionCycleEmployeesMaintain extends ManyToManyDetailsMaintain {
    ...
    public AppMainLayout appMainLayoutBuilder() {
        ...
        if (viewId.equals("/module/reg/jsps/decisionCycle/shared/selectdecisionemployee.jsp")) {
        ...
        if (viewId.equals("/module/jsps/decisionCycle/shared/selectdecisionemployee.jsp") || 
    ...
    public List getCurrentDisplayDetails() {
        ...
        DecisionCycleMaintainBean decisionBean = 
            (DecisionCycleMaintainBean)BeansUtil.getValue("decisionCycleMaintainBean");
    ...
    private void navigateToDecision() {
        ...
        String pageNavigation = "decisioncycleemployeesmaintain";
//        if ((Boolean)app.createValueBinding("#{decisionMaintainBean.cancelDecisionMode}").getValue(fContext)) {
//            pageNavigation += "cancel";
//        }

        if ((Boolean)app.createValueBinding("#{decisionCycleMaintainBean.maintainMode == 1}").getValue(fContext)) {
            pageNavigation += "edit";
        }
    ...
    public String navigateAdd() {
        try {
            advanceEmployeesAddBean.setReturnMethod("decisionCycleEmployeesMaintainBean.employeeAddMethod");
            advanceEmployeesAddBean.setBackMethod("decisionCycleEmployeesMaintainBean.backFromSearch");
            advanceEmployeesAddBean.setSearchMethod("empDecisionCycleAddBean.filterSearchByEmpWithPaging");
            ...
            AbstractDecisionListBean decisionListBean = 
                (AbstractDecisionListBean)FacesContext.getCurrentInstance().getApplication().createValueBinding("#{decisionAbstractListBean}").getValue(FacesContext.getCurrentInstance());
...
//            ((IDecisionsDTO)decisionBean.getPageDTO()).setEmpDecisionsDTOList(getCurrentDetails());
        ...
        return "decisioncycleemployeesmaintain";
    }
...
//        }
    ...
    public void showSearchForEmployeeDiv() {
         employeeListOfValuesBean.setReturnMethodName("decisionCycleEmployeesMaintainBean.returnMethodAction");
