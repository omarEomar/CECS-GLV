...
public class RelatedMaterialsCycle extends BaseBean {

	@SuppressWarnings("compatibility:-4485906751177687898")
	private static final long serialVersionUID = 1L;


    private AbstractDecisionListBean decisionListBean;
    ...
    private DecisionCycleMaterialsMaintain decisionMaterialsMaintainBean;
    ...
    public RelatedMaterialsCycle() {
            DecisionCycleMaintainBean decisionCycleMaintainBean = 
                     (DecisionCycleMaintainBean)evaluateValueBinding("decisionCycleMaintainBean");
             
        if(decisionCycleMaintainBean.getCurrentStag()==1L){
            decisionListBean = 
                    (AbstractDecisionListBean)evaluateValueBinding("decisionSuggestionListBean");
        }if(decisionCycleMaintainBean.getCurrentStag()==2L){
            decisionListBean = 
                    (AbstractDecisionListBean)evaluateValueBinding("decisionRevisionListBean");
        }if(decisionCycleMaintainBean.getCurrentStag()==3L){
            decisionListBean = 
                    (AbstractDecisionListBean)evaluateValueBinding("decisionExcuteListBean");
        }else{
            decisionListBean = 
                    (AbstractDecisionListBean)evaluateValueBinding("decisionAbstractListBean");
        }
    ...
    public void search(){
        ...
        try{
            getDecisionSearchDTO().setRegulationStatus(1l);
            decsList = (List) RegClientFactory.getDecisionsClient().searchWithStatus(decisionSearchDTO);
