...
import com.beshara.csc.nl.reg.business.entity.IRegPersonDecisionsEntityKey;
import com.beshara.csc.nl.reg.business.entity.RegEntityKeyFactory;
import com.beshara.csc.nl.reg.integration.presentation.backingbean.decision.DecisionListBean;
import com.beshara.csc.nl.reg.integration.presentation.backingbean.decision.DecisionMaintainBean;
import com.beshara.csc.nl.reg.integration.presentation.backingbean.decision.details.advanceSearch.AdvanceEmployeesAddBean;
import com.beshara.csc.nl.reg.integration.presentation.backingbean.regulation.details.RegulationModulesMaintain;
...
public class DecisionEmployeesMaintain extends ManyToManyDetailsMaintain {
    ...
    private IRegPersonDecisionsDTO personDecisionsDTO = RegDTOFactory.createRegPersonDecisionsDTO();
    private List<IRegPersonDecisionsDTO> personDecisionsDTOList = new ArrayList<IRegPersonDecisionsDTO>();
    ...
    public DecisionEmployeesMaintain() {
        if (getIntegrationBean().getHmBaseBeanFrom().get("isEmployee") != null) {
            isEmployee = (Boolean)getIntegrationBean().getHmBaseBeanFrom().get("isEmployee");
        }
        if (isEmployee) {
            setClient(RegClientFactory.getEmpDecisionsClient());
            setEmpDecisionsDTOSlelected(RegDTOFactory.createEmpDecisionsDTO());
        } else {
            setClient(RegClientFactory.getRegPersonDecisionsClient());
            setPersonDecisionsDTO(RegDTOFactory.createRegPersonDecisionsDTO());
        }
        ...
        setDivMainContentMany("divMainContentManyThreeRows");
    }
    ...
    public PagingResponseDTO initEmpBean(PagingRequestDTO request) {
        ...
        //            for (int i = 0; i < ((IDecisionsDTO)decisionMaintainBean.getPageDTO()).getEmpDecisionsDTOList().size();
        //                 i++) {
    ...
    public List getCurrentDisplayDetails() {
        ...
        if (super.getCurrentDetails() == null || super.getCurrentDetails().size() == 0) {
            if (getIntegrationBean() != null && getIntegrationBean().getSelectedDTOFrom() != null &&
                ...
                setCurrentDisplayDetails(new ArrayList());
                ...
                if (getIntegrationBean().getHmBaseBeanFrom().get("isEmployee") != null) {
                    ...
                    if (isEmployee) {
                        ...
                        ((IDecisionsDTO)decisionBean.getPageDTO()).setRegPersonDecisionDtoList(getCurrentDetails());
                    }
                } else {
                    ((IDecisionsDTO)decisionBean.getPageDTO()).setEmpDecisionsDTOList(getCurrentDetails());
                }
    ...
    private void navigateToDecision() {
        ...
        app.createValueBinding("#{wizardbar.currentStep}").setValue(fContext, "employeesadd");
    ...
    public String navigateAdd() {
        try {
            ...
            if (decisionBean.getPageDTO() != null)
                advanceEmployeesAddBean.getSavedData().add(0, decisionBean.getPageDTO());
            advanceEmployeesAddBean.getSavedData().add(1, decisionBean.getMaintainMode());
            advanceEmployeesAddBean.getSavedData().add(2, getWizardBar().getConfigurationId());
            advanceEmployeesAddBean.getSavedData().add(3, getWizardBar().getWizardSteps());
            advanceEmployeesAddBean.getSavedData().add(4, decisionBean.isShowPrevious());
            advanceEmployeesAddBean.getSavedData().add(5, decisionBean.isRenderFinish());
            advanceEmployeesAddBean.getSavedData().add(6, decisionBean.isRenderSave());
            advanceEmployeesAddBean.getSavedData().add(7, decisionBean.getNextNavigationCase());
            advanceEmployeesAddBean.getSavedData().add(8, decisionBean.getPreviousNavigationCase());
            advanceEmployeesAddBean.getSavedData().add(9, decisionBean.getFinishNavigationCase());
            advanceEmployeesAddBean.getSavedData().add(10, decisionBean.getCurrentNavigationCase());
            advanceEmployeesAddBean.getSavedData().add(11, employeesList);
            advanceEmployeesAddBean.getSavedData().add(12, decisionListBean.getIndexArray());
            advanceEmployeesAddBean.getSavedData().add(13, decisionListBean.getSortColumn());
            advanceEmployeesAddBean.getSavedData().add(14, decisionListBean.isSaveSortingState());
            advanceEmployeesAddBean.getSavedData().add(15, decisionListBean.isSortAscending());
            advanceEmployeesAddBean.getSavedData().add(16, decisionListBean.getFullColumnName());
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void addFinancial() {
        ...
        if (getCurrentDetails() != null && getCurrentDetails().size() != 0) {
            for (int i = 0; i < getCurrentDetails().size(); i++) {
                if (getEmpDecisionsDTOSlelected().getCode() == getCurrentDetails().get(i).getCode()) {
                    ...
                    if (getCurrentDetails().get(i).getStatusFlag() != null) {
                        if (getCurrentDetails().get(i).getStatusFlag() == 4L) {
                            (getCurrentDetails().get(i)).setStatusFlag(null);
                        }
                    }
                }
            ...
            if (decisionEmployeesModelSessionBean.getAddElementMap().containsKey(((IEmpDecisionsEntityKey)getEmpDecisionsDTOSlelected().getCode()).getCivilId())) {
                IEmpDecisionsDTO dto =
                    (IEmpDecisionsDTO)decisionEmployeesModelSessionBean.getAddElementMap().get(((IEmpDecisionsEntityKey)getEmpDecisionsDTOSlelected().getCode()).getCivilId());
    ...
    public IBasicDTO mapToCodeNameDTO(IBasicDTO dto) {
        ...
        if (isEmployee) {
            ...
            return ((IRegPersonDecisionsDTO)dto).getKwtCitizensResidentsDTO();
        }
    ...
    public IBasicDTO mapToDetailDTO(IBasicDTO dto) {
        ...
        if (isEmployee) {
            ...
            empIDecisionsDTO.setEmployeesDTO(dto);
            empIDecisionsDTO.setTableName((String)getIntegrationBean().getHmBaseBeanFrom().get("tableName"));
            ...
            IRegPersonDecisionsDTO personDecisionsDTO = RegDTOFactory.createRegPersonDecisionsDTO();
            try {
                personDecisionsDTO.setTableName((String)getIntegrationBean().getHmBaseBeanFrom().get("tableName"));
                personDecisionsDTO.setKwtCitizensResidentsDTO((IKwtCitizensResidentsDTO)InfClientFactory.getKwtCitizensResidentsClient().getCitizenName(Long.valueOf(dto.getCode().getKey())));
                personDecisionsDTO.getKwtCitizensResidentsDTO().setCode(dto.getCode());
            } catch (DataBaseException e) {
                e.printStackTrace();
            } catch (SharedApplicationException e) {
                e.printStackTrace();
            ...
            IDecisionsDTO decisionsDTO = null;
            IDecisionsEntityKey decisionsEntityKey = null;
            IRegPersonDecisionsEntityKey personDecisionsEntityKey = null;
            if (this.getMasterEntityKey() != null) {
                decisionsEntityKey = (IDecisionsEntityKey)this.getMasterEntityKey();
                decisionsDTO = RegDTOFactory.createDecisionsDTO();
                decisionsDTO.setCode(decisionsEntityKey);
                personDecisionsDTO.setDecisionsDTO(decisionsDTO);
            }
            if (decisionsEntityKey != null) {
                personDecisionsEntityKey =
                        RegEntityKeyFactory.createRegPersonDecisionsEntityKey(decisionsEntityKey.getDectypeCode(),
                                                                              decisionsEntityKey.getDecyearCode(),
                                                                              decisionsEntityKey.getDecisionNumber(),
                                                                              Long.valueOf(dto.getCode().getKey().toString()));
            } else {
                personDecisionsEntityKey =
                        RegEntityKeyFactory.createRegPersonDecisionsEntityKey(null, null, null, Long.valueOf(dto.getCode().getKey().toString()));
            }
            personDecisionsDTO.setCode(personDecisionsEntityKey);
            return personDecisionsDTO;
        }
    ...
    public void selectedCurrent(ActionEvent event) throws Exception {
        ...
        if (getEmpDecisionsDTOSlelectedList().size() == 1) {
            if ((getEmpDecisionsDTOSlelectedList().get(0).getTableName() == null) ||
                getEmpDecisionsDTOSlelectedList().get(0).getStatusFlag() != null) {
    ...
    public void empIDecisionsDTOModule() {
        ...
        int rowIndex = regulationModulesMaintainBean.getSelectedAvailableDetailsRowIndices().get(0);
        Vector rowData = (Vector)regulationModulesMaintainBean.getCustomAvailableDetails().get(rowIndex);
    ...
    public String employeeAddMethod() {
        try {
            ...
            List<IEmployeesDTO> employeesList = (List)advanceEmployeesAddBean.getCurrentDetails();

            List<IBasicDTO> empDecisionListList = (List<IBasicDTO>)advanceEmployeesAddBean.getSavedData().get(11);
            //setCurrentDetails(empDecisionListList);
            if (employeesList != null && employeesList.size() > 0) {
                for (IEmployeesDTO emp : employeesList) {
                    if (emp.getStatusFlag() != null && emp.getStatusFlag().equals(added) &&
                        getCurrentSelectedDetail(emp) == null) {
                        IEmpDecisionsDTO empIDecisionsDTO = (IEmpDecisionsDTO)mapToDetailDTO(emp);
            ...
            if (decisionBean.getPageDTO() != null && decisionBean.getPageDTO().getCode() != null)
    ...
    public List<IBasicDTO> getInformTypeList() {
        try {
            ...
            informTypeList = RegClientFactory.getRegEmpInformTypesClient().getAll();
    ...
    public void findPersonByCivilIDFromEmployees() {
        try {
            ...
            setCivilID(null);
            getSharedUtil().handleException(e, "com.beshara.csc.nl.reg.integration.presentation.resources.integration",
    ...
    public void setPersonDecisionsDTO(IRegPersonDecisionsDTO personDecisionsDTO) {
        this.personDecisionsDTO = personDecisionsDTO;
    }

    public IRegPersonDecisionsDTO getPersonDecisionsDTO() {
        return personDecisionsDTO;
    }

    public void setPersonDecisionsDTOList(List<IRegPersonDecisionsDTO> PersonDecisionsDTOList) {
        this.personDecisionsDTOList = PersonDecisionsDTOList;
    }

    public List<IRegPersonDecisionsDTO> getPersonDecisionsDTOList() {
        return personDecisionsDTOList;
    }
