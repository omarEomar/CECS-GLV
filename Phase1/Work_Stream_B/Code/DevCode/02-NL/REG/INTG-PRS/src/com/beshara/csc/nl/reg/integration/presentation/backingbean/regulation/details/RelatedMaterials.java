...
import com.beshara.csc.nl.reg.integration.presentation.backingbean.regulation.RegulationListBean;
...
public class RelatedMaterials extends BaseBean {
    ...
    private RegulationListBean regulationListBean;
    ...
    public RelatedMaterials() {
        ...
        regulationListBean = 
                (RegulationListBean)evaluateValueBinding("regulationListBean");

        if (currentMaterial == null) {
            regulationMaterialsMaintainBean = 
                    (RegulationMaterialsMaintain)evaluateValueBinding("regulationMaterialsMaintainBean");
    ...
    public void search() {
        regulationListBean.getRegulationSearchDTO().setRegulationStatus(1l);
        List<IRegulationsDTO> regsList = 
            (List)regulationListBean.getSearchResult();

        RegulationMaintainBean regulationMaintainBean = 
            (RegulationMaintainBean)evaluateValueBinding("regulationMaintainBean");
    ...
    public void resetSearch() {
        ...
        regulationListBean.setRegulationSearchDTO(RegDTOFactory.createRegulationSearchDTO());
        getLovBaseBean().setSelectedRadio("");
