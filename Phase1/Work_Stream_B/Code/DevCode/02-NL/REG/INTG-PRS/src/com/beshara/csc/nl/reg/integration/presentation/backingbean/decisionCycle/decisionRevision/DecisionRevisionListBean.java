package com.beshara.csc.nl.reg.integration.presentation.backingbean.decisionCycle.decisionRevision;
...
import com.beshara.csc.nl.reg.integration.presentation.backingbean.decisionCycle.IncludedEmployeesList;
import com.beshara.csc.nl.reg.integration.presentation.backingbean.decisionCycle.details.DecisionCycleMainDataMaintain;
...
public class DecisionRevisionListBean extends AbstractDecisionListBean{
    ...
    public void completeRevision() {
        ...
        try {
            ...
            getSharedUtil().handleException(e,"com.beshara.csc.nl.reg.integration.presentation.resources.integration","failed_revision");
        } finally {
            if (!isShowAllFlag()) {
                try {
                    search();
        ...
        getSharedUtil().handleSuccMsg("com.beshara.csc.nl.reg.integration.presentation.resources.integration","success_revision");
    }
